            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Pour toute information, conseils, ou ouverture de dossier, consultez la rubrique contact pour nous rejoindre par téléphone, fax, email, ou sur place dans notre local.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                    ...
                    <div className="space-y-8">
                            ...
                            {[
                                {
                                    icon: PhoneIcon,
                                    title: "Télephone & GSM",
                                    content: "Bur: (+216) 71 242 645",
                                    sub: "GSM: (+216) 21 321 321 / 98 445 897"
                                },
                                {
                                ...
                                <Card key={i} className="flex items-start gap-4 p-6 hover:shadow-md transition-all border-none bg-white">
                        ...
                        <div className="h-[300px] w-full rounded-2xl overflow-hidden relative shadow-lg border border-slate-200">
                            <iframe
